...
import { FaHtml5, FaCss3Alt, FaJs, FaReact, FaGithub, FaPython, FaAws, FaDatabase, FaNodeJs } from 'react-icons/fa';
import { SiNextdotjs, SiTailwindcss, SiMysql, SiVercel, SiFlutter, SiAmazondynamodb } from 'react-icons/si';
...
const skills = [
  ...
  { name: 'DynamoDB', icon: <SiAmazondynamodb size={32} />, color: '#4053D6' },
        ...
        >
          {skills.map(skill => (
            ...
            >
              ...
              <span style={{ color: 'var(--muted)', fontSize: '0.72rem', fontWeight: 600, letterSpacing: '0.03em', textAlign: 'center' }}>
                {skill.name}
              </span>
            </motion.div>
          ))}
