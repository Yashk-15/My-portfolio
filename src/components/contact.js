    ...
    <section id="contact" style={{ padding: '100px 0', borderTop: '1px solid var(--border)' }}>
      <div className="container-main">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'flex-start' }} className="contact-grid">
          ...
          >
            {[
              { icon: <FaEnvelope size={15} />, label: 'yashjk1505@outlook.com', href: 'mailto:yashjk1505@outlook.com', color: '#f87171' },
          ...
          >
            <div style={{
              width: 40, height: 40, background: 'var(--accent-dim)', borderRadius: 10,
              border: '1px solid rgba(61,90,128,0.2)', display: 'flex', alignItems: 'center',
              justifyContent: 'center', marginBottom: 20,
            }}>
              <FaEnvelope color="var(--accent)" size={16} />
            </div>
            <h3 style={{ color: 'var(--text)', fontWeight: 700, fontSize: '1.1rem', marginBottom: 10 }}>
            ...
            <a href="mailto:yashjk1505@outlook.com" className="btn-outline">
              Send me a message
            </a>
          </motion.div>
        </div>
